# 1.1 get train data and test data
...
# 2 extract the mean and standard deviation and assign names to data table
...
# 5 calculate average of each variable and order the data by subject and by activity
